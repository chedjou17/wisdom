...
export const site = {
  ...
  url: process.env.NEXT_PUBLIC_SITE_URL || "https://www.wisdomlogistic.com",
  whatsapp: process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || "33778193567",
  phone: process.env.NEXT_PUBLIC_PHONE_DISPLAY || "+33 7 78 19 35 67",
  email: process.env.NEXT_PUBLIC_CONTACT_EMAIL || "contact@wisdomlogistic.com",
  quoteEmail: process.env.NEXT_PUBLIC_FORMSUBMIT_EMAIL || "contact@wisdomlogistic.com",
